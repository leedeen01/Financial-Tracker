        ...
        async ([userId, amount]) => {
          ...
          if (user) {
            ...
            const expense: FriendsExpenseRequestBody = {
              ...
              selfCurrency: (await ExpensesApi.fetchCurrencies(loggedInUser.currency, currency)).toString(),
              toCurrency: await ExpensesApi.fetchCurrencies(receive.currency, currency).toString(),
