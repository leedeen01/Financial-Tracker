...
const PendingPayment = ({
  ...
  const pendingCount = friendExpenseRequest
    ...
    .filter(expense => expense.receiveMoneyName === userToPay.username || expense.sendMoneyName === userToPay.username)
    .length;
                  ...
                  <div className="col-md-12">
                    <div className="card h-md-100">
                      <div className="card-header pending-send">
                        <h6 className="overflow-text mb-0">{expense.description}</h6>
                      </div>
                      <div className="card-body d-flex flex-row justify-content-between align-items-center">
                        <p>To Pay: ${parseFloat(expense.amount).toFixed(2)}</p>
                        <div>
                          <button onClick={() => acceptFriendExpenseRequest(expense.receiveMoney, expense)} className="friend-button friend-button-accept">
                            <svg viewBox="0 0 16 16" height="16" width="16" xmlns="http://www.w3.org/2000/svg" className="icon">
                              <path fillRule="evenodd" d="M13.485 3.515a.75.75 0 0 1 0 1.06l-7.5 7.5a.75.75 0 0 1-1.06 0l-3.25-3.25a.75.75 0 1 1 1.06-1.06L6 10.439l6.97-6.97a.75.75 0 0 1 1.06 0z"></path>
                            </svg>
                          </button>
                          <button onClick={() => declineFriendExpenseRequest(expense.receiveMoney, expense)} className="friend-button friend-button-reject">
                            <svg viewBox="0 0 16 16" height="16" width="16" xmlns="http://www.w3.org/2000/svg" className="icon">
                              <path fillRule="evenodd" d="M3.707 3.293a1 1 0 0 1 1.414 0L8 6.172l2.879-2.879a1 1 0 1 1 1.414 1.414L9.414 8l2.879 2.879a1 1 0 1 1-1.414 1.414L8 9.414l-2.879 2.879a1 1 0 0 1-1.414-1.414L6.586 8 3.707 5.121a1 1 0 0 1 0-1.414z"></path>
                            </svg>
                          </button>
                        </div>
                      </div>
                ...
                <>
                  <div className="col-md-12">
                    <div className="card h-md-100">
                      ...
                      <div className="card-body d-flex flex-row justify-content-between align-items-center">
                        <p>To Receive: ${parseFloat(expense.amount).toFixed(2)}</p>
                        <h6>Request Sent</h6>
                      </div>
                    </div>
                  </div>
