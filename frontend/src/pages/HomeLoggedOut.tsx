...
const HomeLoggedOut = () => {
  return (
    <>
      <div className="d-flex justify-content-center gap-3 flex-column background-black">
        <div className="home-section d-flex flex-column vh-80 justify-content-center align-items-center overflow-hidden">
          <video src={home1} autoPlay loop muted id="home1-video">
          ...
          <div className="home-title-container">
            ...
            <div
              ...
              data-aos-once="true"
            >
              <span className="home-text-gold">Power</span>ful.
            </div>
          </div>
          <div
            ...
            data-aos-once="true"
          >
            Maximize your financial insights with Trackspence.
          </div>
        </div>
        <div className="home-section2 d-flex flex-wrap justify-content-center align-items-center">
          <div className="home2-text d-flex flex-column justify-content-center align-items-center mt-5">
            <div
              ...
              data-aos-once="true"
            >
              Log & Go <i className="fa fa-long-arrow-right"></i>
            </div>
            <div
              className="home-subtitle"
              data-aos="fade-right"
              ...
              data-aos-once="true"
            >
              Masterfully engineered to provide you with the best experience
              possible. All it takes is a simple click.
            </div>
          </div>
          <img
            src={home2}
        ...
        <div className="home-section3 d-flex flex-column vh-80 justify-content-center align-items-center overflow-hidden">
          ...
          <div
            ...
            data-aos-once="true"
          >
            As a web app, Trackspence work seamlessly across all smart devices.
            Well, maybe not your watch — yet. But give it a try and tell us how
            it goes!
          </div>
        </div>
        <div className="home-section4 row mx-auto">
          <div
            className="home4-left col-md-6"
            data-aos="flip-right"
            data-aos-easing="ease"
            data-aos-delay="0"
            data-aos-once="true"
          >
            <div
              ...
              data-aos-once="true"
            >
              <span className="home-text-gold">Gold</span>
            </div>
            <img
              src={home4img1}
              alt=""
              className="home-4-img"
              data-aos="fade-right"
              data-aos-easing="ease"
              data-aos-delay="100"
              data-aos-once="true"
          ...
          <div
            className="home4-right col-md-6"
            data-aos="flip-left"
            data-aos-easing="ease"
            data-aos-delay="0"
            data-aos-once="true"
        ...
        <div className="home-section6 d-flex flex-column vh-80 justify-content-center align-items-center overflow-hidden">
          ...
          <div
            ...
            data-aos-once="true"
          >
            Congratulations! Unlike some other budgeting apps, your first
            recorded transaction won't be a subscription fee.
          </div>
        </div>
      </div>
    </>
